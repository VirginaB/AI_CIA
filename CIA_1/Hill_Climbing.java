...
public class GraphHC {
    ...
    public static List<String> hillClimb(Map<String, Map<String, Double>> d_heur, String start, String end) {
        ...
        while (!queue.isEmpty()) {
            ...
            System.out.println("Exploring node: " + cn);
            System.out.println("Current path: " + cp);
            ...
            if (cn.equals(end)) {
                ...
                sl.sort((a, b) -> Double.compare(d_heur.get(cn).get(b.get(b.size() - 1)), d_heur.get(cn).get(a.get(a.size() - 1))));
