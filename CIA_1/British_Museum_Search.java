...
public class GraphBMS {
    ...
    // Breadth-First Search implementation with step printing
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (DefaultEdge edge : graph.edgeSet()) {
                ...
                if (isEdgeInCurrentPath(source, target)) {
                    g2d.setColor(Color.RED); // Red color for the current path
                } else {
                    g2d.setColor(Color.GREEN); // Green color for explored edges
                }
